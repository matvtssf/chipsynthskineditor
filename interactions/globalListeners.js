...
// --- Phase 2: Clipboard Memory State, Structural Swapping & Validation Shield ---
...
function isValidDropTarget(childTag, parentTag) {
    ...
    const ALLOWED_PARENTS = ['view', 'pane', 'group', 'container', 'tabview', 'skin'];
    if (!ALLOWED_PARENTS.includes(parent)) return false;
