 ...
 */
import * as State from './state.js'; // Assuming state is accessible globally or passed
...
import { setElementUnsavedChanges, updateElementSupportedStatus } from './references.js'; // <<< CORRECT: Use imported version
