...
import { handleFileSelection } from './fileLoader.js';
// updateGuiZoom is called by handleZoomChange, so mainContentInteractions imports this, and this imports from mainContentInteractions.
// This can be a sign of tangled responsibilities, but is a common pattern.
...
import { makeModalDraggable, toggleModalVisibility } from './modalManager.js';
import { openXmlEditor } from './xmlEditor.js';
