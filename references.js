...
/** Attempts to load ELEMENT reference data from ./reference-data.json on startup */
export async function loadInitialElementReferenceData() {
    console.log("[SYNC References DEBUG] === Attempting to load initial ELEMENT reference data from ./reference-data.json ===");
...
/** Attempts to load PARAMETER reference data from ./param-data.json on startup */
export async function loadInitialParamReferenceData() {
    console.log("[SYNC References DEBUG] === Attempting to load initial PARAMETER reference data from ./param-data.json ===");
    paramDataLoaded = false;
    setParamDataChanged(false);
    try {
        const response = await fetch('./param-data.json');
